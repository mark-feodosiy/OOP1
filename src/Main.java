public class Main {
    public static void main(String[] args) {
        //Домашка ООП1
        Gryffindor a1 = new Gryffindor("Гарри Поттер", 100, 100, 100, 100, 100);
        ...
        Ravenclaw c1 = new Ravenclaw("Чжоу Чанг", 70, 80, 90, 52, 75, 64);
        Ravenclaw c2 = new Ravenclaw("Падма Патил", 50, 50, 70, 62, 45, 80);
        Ravenclaw c3 = new Ravenclaw("Маркус Белби", 40, 68, 94, 47, 67, 70);
